            ...
            case 3://ustawienie na ścianie "c"
                if ((int) c != 0) {
                    ...
                    if (b > 0 && (int) c > 0 && (m.get(z, ((int) b) - 1) != 0)) {
                        m.put(0, z, ((int) b) - 1);
                        individual.setDoor(new Door(((int) b), z, doors.getLength(), 1, doors.getPrice(), doors.getImageID()));
                        costSum = individual.getCostSum();
                        individual.setCostSum(costSum + doors.getPrice());
            ...
            case 4://ustawienie na ścianie "d"
                if ((int) d != 0) {
                    ...
                    if ((((int) b) + z) < (m.getColumnNumber()) && ((int) d > 0) && (int) c < m.getRowNumber() && (m.get((int) c, ((int) b) + z) != 0)) {
                        ...
                        individual.setDoor(new Door(((int) b) + z, (int) c, doors.getLength(), 0, doors.getPrice(), doors.getImageID()));
                        costSum = individual.getCostSum();
                        individual.setCostSum(costSum + doors.getPrice());
            ...
            case 5://ustawienie na ścianie "e"
                if ((int) e != 0) {
                    ...
                    if ((int) e > 0 && (m.get((int) c + z, (m.getColumnNumber()) - 1) != 0)) {
                        ...
                        individual.setDoor(new Door(m.getColumnNumber(), (int) c + z, doors.getLength(), 1, doors.getPrice(), doors.getImageID()));
                        costSum = individual.getCostSum();
                        individual.setCostSum(costSum + doors.getPrice());
            ...
            case 6://ustawienie na ścianie "f"
                if ((int) m.getColumnNumber() != 0) {
                    ...
                    if (m.get((m.getRowNumber()) - 1, z) != 0) {
                        ...
                        individual.setDoor(new Door(z, (int) a, doors.getLength(), 0, doors.getPrice(), doors.getImageID()));
                        costSum = individual.getCostSum();
                        individual.setCostSum(costSum + doors.getPrice());
